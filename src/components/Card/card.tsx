  ...
  return (
    <div>
      <Suspense fallback={<div>Loading Card Content...</div>}>
          <div className={`${cardProps.category}-card border-2 border-gray-300 rounded-lg shadow-lg p-1 h-100 w-70 ${cardProps.color} flex flex-col justify-between items-center transaction duration-500 ease-in-out`}>
            ...
            <div className="card-content h-[50%] mt-2">
              <div className="card-text h-[70%] p-1">
                <h2 className='font-bold text-black text-2xl serif'>{cardProps.title}</h2>
                <p className='text-gray-600'>{cardProps.description}</p>
              </div>
